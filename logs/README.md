...
[runbook logging contract](../docs/operations/RUNBOOK.md#logs).
...
[`TROUBLESHOOTING.md`](../docs/operations/TROUBLESHOOTING.md#logsout-no-such-file-or-directory-at-submit-time).
