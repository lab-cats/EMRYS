...
| How do current owners map to target responsibilities? | [Current-to-target responsibility crosswalk](ARCHITECTURE.md#current-to-target-responsibility-crosswalk) |
