...
| `tests/pending/test_step_04_mark_duplicates.sh` | 1 | Intentional non-runnable pending-plan scaffold retained for its separate still-unselected no-loss owner/retirement review. No disposition from the Step `05` review applies to this path. |
