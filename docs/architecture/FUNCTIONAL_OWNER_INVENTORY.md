...
| [`02` — `construct_canonical_BAM`](../../src/norad/stages/construct_canonical_BAM/CONTRACT.md) | [`step_02_sort_index_bam.sh`](../../scripts/step_02_sort_index_bam.sh), [`step_02_sort_index_bam.slurm`](../../jobs/step_02_sort_index_bam.slurm) | [`validate_step_02_canonical_bam.py`](../../scripts/validate_step_02_canonical_bam.py) | [shell contract](../../tests/shell/test_step_02_sort_index_bam.sh), [`test_validate_step_02_canonical_bam.py`](../../tests/test_validate_step_02_canonical_bam.py) |
| [`02b` — `collect_canonical_BAM_QC_evidence`](../../src/norad/evidence/collect_canonical_BAM_QC_evidence/CONTRACT.md) | [`step_02b_bam_qc.sh`](../../scripts/step_02b_bam_qc.sh), [`step_02b_bam_qc.slurm`](../../jobs/step_02b_bam_qc.slurm) | [`validate_step_02b_bam_qc.py`](../../scripts/validate_step_02b_bam_qc.py) | [shell contract](../../tests/shell/test_step_02b_bam_qc.sh), [`test_validate_step_02b_bam_qc.py`](../../tests/test_validate_step_02b_bam_qc.py) |
| [`03` — `collect_RSeQC_paired_orientation_evidence`](../../src/norad/evidence/collect_RSeQC_paired_orientation_evidence/CONTRACT.md) | [`step_03_infer_strandedness_and_orientation.sh`](../../scripts/step_03_infer_strandedness_and_orientation.sh), [`step_03_infer_strandedness_and_orientation.slurm`](../../jobs/step_03_infer_strandedness_and_orientation.slurm) | [`validate_step_03_rseqc_orientation.py`](../../scripts/validate_step_03_rseqc_orientation.py) | [shell contract](../../tests/shell/test_step_03_infer_strandedness_and_orientation.sh), [`test_validate_step_03_rseqc_orientation.py`](../../tests/test_validate_step_03_rseqc_orientation.py) |
| [`04` — `mark_BAM_duplicates_with_Picard`](../../src/norad/stages/mark_BAM_duplicates_with_Picard/CONTRACT.md) | [`step_04_mark_duplicates.sh`](../../scripts/step_04_mark_duplicates.sh), [`step_04_mark_duplicates.slurm`](../../jobs/step_04_mark_duplicates.slurm) | [`validate_step_04_mark_duplicates.py`](../../scripts/validate_step_04_mark_duplicates.py) | [shell contract](../../tests/shell/test_step_04_mark_duplicates.sh), [`test_validate_step_04_mark_duplicates.py`](../../tests/test_validate_step_04_mark_duplicates.py) |
| [`05` — `split_N_cigar_reads_with_GATK`](../../src/norad/stages/split_N_cigar_reads_with_GATK/CONTRACT.md) | [`step_05_split_n_cigar_reads.sh`](../../scripts/step_05_split_n_cigar_reads.sh), [`step_05_split_n_cigar_reads.slurm`](../../jobs/step_05_split_n_cigar_reads.slurm) | [`validate_step_05_split_ncigar.py`](../../scripts/validate_step_05_split_ncigar.py) | [shell contract](../../tests/shell/test_step_05_split_n_cigar_reads.sh), [`test_validate_step_05_split_ncigar.py`](../../tests/test_validate_step_05_split_ncigar.py) |
| [`06` — `partition_BAM_by_mechanical_read_orientation`](../../src/norad/stages/partition_BAM_by_mechanical_read_orientation/CONTRACT.md) | [`step_06_split_bam_by_read_orientation.sh`](../../scripts/step_06_split_bam_by_read_orientation.sh), [`step_06_split_bam_by_read_orientation.slurm`](../../jobs/step_06_split_bam_by_read_orientation.slurm) | [`validate_step_06_orientation_outputs.py`](../../scripts/validate_step_06_orientation_outputs.py) | [shell contract](../../tests/shell/test_step_06_split_bam_by_read_orientation.sh), [`test_validate_step_06_orientation_outputs.py`](../../tests/test_validate_step_06_orientation_outputs.py) |
...
| Reference provenance evidence | [`reference_provenance.py`](../../scripts/reference_provenance.py) | [`test_reference_provenance.py`](../../tests/test_reference_provenance.py). This inventories declared reference identity and consistency without repairing reference artifacts. The final FASTA-sidecar validator uses a private exact-file bridge to this unchanged public owner; the Step `05` consumer remains flat and unchanged. |
...
- Shared validation-report publication belongs to the neutral
  ...
  owner. The final `construct_STAR_index` and `convert_GTF_to_BED12` validators
  and eleven legacy-path validators use temporary exact-file private loaders
  until any later packaging decision or functional-owner migration.
...
The protected current roster contains 25 public Python entry points (22 under
`scripts/` and three final owner-local entry points), 13 top-level shell entry
points, 4 R entry points, 7 Git-orchestration entry points, 16 SLURM jobs (14
under `jobs/` and two final owner-local jobs), and 23 public Make targets. Every
