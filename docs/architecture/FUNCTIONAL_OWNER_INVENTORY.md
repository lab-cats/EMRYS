...
- Shared validation-report publication belongs to the neutral
  ...
  owner. Five final owner validators and eight legacy-path validators use
...
- Shared samtools execution and BAM-header parsing belong to neutral private
  ...
  Step `02` validator and flat Step `04`/`05` validators exact-load it; no
