> **Historical record**
>
> Audit date: 2026-07-30. Originating path:
> `docs/design/REFACTOR_AUDIT.md`. Initial record commit:
> `02c1ae8138ed105621bb40cccee5498f9b7f5782`. Frozen source snapshot:
> `dcdb371c766c337e4f6c864810d5c7bd4da023f2`, last amended 2026-07-31;
> source blob: `f60c07130287ff4da0a9d7681b3871ddd8e7f1db`. Audited target:
> `5bdf53664d72f047d88f4a59d38ff2d8c80dc503`.
>
> This record preserves the complete dated evidence, rankings, dispositions,
> and recommendations. It is not a current roadmap, status, or contract owner.
> Relocation changed only four relative link destinations so they continue to
> reach the same design owners; all other source-body text remains unchanged.
...
- **Resolution evidence:** [`TEST_BASELINE.md`](../../design/TEST_BASELINE.md) now names
...
1. The developer-only Python coverage baseline and public-contract matrix are
   established in [`TEST_BASELINE.md`](../../design/TEST_BASELINE.md) before any production
   refactor.
