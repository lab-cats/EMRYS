...
at published checkpoint `ee25492`; architecture selection `bc2112c` is
published, and `REVIEW-ARCH-03F` completes in the commit containing this
paragraph. Reliability, usability, migration, and later owners remain
unselected.
