...
defined at published checkpoint `417a2a5`; `REVIEW-ARCH-03G` alone is selected
in the commit containing this paragraph. Step `03`, Step `04`, and all later
owner cards remain uncreated and unselected.
