...
| Phase `03` eighth bounded package | Move `collect_RSeQC_paired_orientation_evidence` through [`MIG-03H`](../tasks/TODO/MIG-03H-migrate-collect-rseqc-paired-orientation-evidence-owner.md) | defined and review-ready but still unselected; ceiling is five moves plus nine explicit updates with separate old-path baseline, executable card gate, and documentation/lifecycle close |
...
checkpoint `1d1de19`; `REVIEW-UX-03H` is complete in the commit containing
this paragraph. Migration, Step `04`, and all later owner/review cards remain
unselected.
