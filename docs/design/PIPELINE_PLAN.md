...
| `codex/mig-03a-extract-validation-report-library` | One-branch physical migration campaign through completed [`MIG-03A`](../tasks/COMPLETED/MIG-03A-extract-validation-report-library.md), [`MIG-03B`](../tasks/COMPLETED/MIG-03B-migrate-construct-star-index-owner.md), [`MIG-03C`](../tasks/COMPLETED/MIG-03C-migrate-convert-gtf-to-bed12-owner.md), [`MIG-03D`](../tasks/COMPLETED/MIG-03D-migrate-align-rna-reads-with-star-owner.md), [`MIG-03E`](../tasks/COMPLETED/MIG-03E-migrate-construct-fasta-sidecars-owner.md), [`MIG-03F`](../tasks/COMPLETED/MIG-03F-migrate-construct-canonical-bam-owner.md), [`MIG-03G`](../tasks/COMPLETED/MIG-03G-migrate-collect-canonical-bam-qc-evidence-owner.md), [`MIG-03H`](../tasks/COMPLETED/MIG-03H-migrate-collect-rseqc-paired-orientation-evidence-owner.md), [`MIG-03I`](../tasks/COMPLETED/MIG-03I-migrate-mark-bam-duplicates-with-picard-owner.md), and [`MIG-03J`](../tasks/COMPLETED/MIG-03J-migrate-split-n-cigar-reads-with-gatk-owner.md), with the eleventh JIT unit [`MIG-03K`](../tasks/TODO/MIG-03K-migrate-partition-bam-by-mechanical-read-orientation-owner.md) defined after completed [`REVIEW-ARCH-03K`](../tasks/COMPLETED/REVIEW-ARCH-03K-review-partition-bam-by-mechanical-read-orientation-migration.md) and [`REVIEW-REL-03K`](../tasks/COMPLETED/REVIEW-REL-03K-review-partition-bam-by-mechanical-read-orientation-migration.md), with active [`REVIEW-UX-03K`](../tasks/IN_PROGRESS/REVIEW-UX-03K-review-partition-bam-by-mechanical-read-orientation-migration.md) | the first ten units are complete through published close `db60dfa`; reliability completion `1d5406a` is published/equal. Usability alone is active; migration remains unselected, and no Step `07` or later owner/review card is preloaded. |
...
| Eleventh JIT-tranche reviews | completed [`REVIEW-ARCH-03K`](../tasks/COMPLETED/REVIEW-ARCH-03K-review-partition-bam-by-mechanical-read-orientation-migration.md) → completed [`REVIEW-REL-03K`](../tasks/COMPLETED/REVIEW-REL-03K-review-partition-bam-by-mechanical-read-orientation-migration.md) → active [`REVIEW-UX-03K`](../tasks/IN_PROGRESS/REVIEW-UX-03K-review-partition-bam-by-mechanical-read-orientation-migration.md) | usability alone is selected from published/equal reliability completion `1d5406a`; migration remains unselected while final commands, diagnostics, preservation, provenance, and evidence-language continuity are reviewed. |
| Phase `03` eleventh bounded package | Unselected move of `partition_BAM_by_mechanical_read_orientation` through [`MIG-03K`](../tasks/TODO/MIG-03K-migrate-partition-bam-by-mechanical-read-orientation-owner.md) | definition only from published close `db60dfa`; the candidate is one Step `06` owner with three native assets, two active direct tests, explicit callers, one pending scaffold to disposition, and no executable/test mutation or Step `07` preload. |
...
That refresh leaves only `partition_BAM_by_mechanical_read_orientation`
eligible because its sole direct predecessor is migrated. The definition
checkpoint containing this plan creates only unselected
...
Architecture is complete at published/equal checkpoint `2452332` with the exact
five-move/nine-update ceiling, modes, final roots, pending-scaffold deletion,
projected native hashes, artifact/coverage boundary, and reverse rollback
recorded. Reliability is complete from published/equal selection `7ca503d` and
fixes five sequential old-path test-only checkpoints for the exact child/count,
transaction, stability/collision, validator, and scheduler obligations.
Usability alone is selected in the commit containing this plan; no finding is
recorded yet. Migration remains unselected, no executable/test path changed,
no computational check ran, and Step `07` and every later owner/review card
remain absent.
