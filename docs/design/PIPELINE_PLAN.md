...
| Ninth JIT-tranche review definitions | unselected [`REVIEW-ARCH-03I`](../tasks/TODO/REVIEW-ARCH-03I-review-mark-bam-duplicates-with-picard-migration.md) → [`REVIEW-REL-03I`](../tasks/TODO/REVIEW-REL-03I-review-mark-bam-duplicates-with-picard-migration.md) → [`REVIEW-UX-03I`](../tasks/TODO/REVIEW-UX-03I-review-mark-bam-duplicates-with-picard-migration.md) | architecture, reliability, and usability passes are defined sequentially for the unique live-DAG-supported Step `04` owner; all remain unselected, independent authorship is not claimed, and no executable/test work has begun |
...
`TODO`. No executable/test file changes or test runs, and Step `05` and every
