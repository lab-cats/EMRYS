...
`13a2748`. The commit containing this paragraph is the separate MIG-03F
documentation/lifecycle close. Later owners remain unselected pending a fresh
live-DAG selection after publication equality.
