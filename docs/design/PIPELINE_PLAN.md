...
the retained fault/evidence boundaries recorded. Usability and migration remain
unselected; no source/test file changed or computational check ran in either
review. Step `06` and every later card remain absent.
