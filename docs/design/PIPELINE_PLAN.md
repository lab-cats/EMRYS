...
| Eighth JIT-tranche reviews | completed [`REVIEW-ARCH-03H`](../tasks/COMPLETED/REVIEW-ARCH-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → completed [`REVIEW-REL-03H`](../tasks/COMPLETED/REVIEW-REL-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → [`REVIEW-UX-03H`](../tasks/TODO/REVIEW-UX-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) | reliability froze predecessor-bearing partial/empty output, producer/validator disagreement, CWD/stable-input, venv/PATH, dry-run-log, stale-wrapper, coverage, and rollback obligations; usability and migration remain unselected |
...
selection `13755af` is published. `REVIEW-REL-03H` completes in the commit
containing this paragraph; usability, migration, Step `04`, and all later
owner/review cards remain unselected.
