...
published, and `REVIEW-ARCH-03G` completes in the commit containing this
paragraph. Reliability, usability, migration, Step `03`, Step `04`, and all
later owner cards remain unselected.
