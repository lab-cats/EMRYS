...
| Tenth JIT-tranche reviews | active [`REVIEW-ARCH-03J`](../tasks/IN_PROGRESS/REVIEW-ARCH-03J-review-split-n-cigar-reads-with-gatk-migration.md) → [`REVIEW-REL-03J`](../tasks/TODO/REVIEW-REL-03J-review-split-n-cigar-reads-with-gatk-migration.md) → [`REVIEW-UX-03J`](../tasks/TODO/REVIEW-UX-03J-review-split-n-cigar-reads-with-gatk-migration.md) | architecture alone is selected; it owns exact loader/cutover and rollback boundaries before reliability may be selected. No review finding is recorded at this selection checkpoint. |
| Phase `03` tenth bounded package | Proposed move of `split_N_cigar_reads_with_GATK` through [`MIG-03J`](../tasks/TODO/MIG-03J-migrate-split-n-cigar-reads-with-gatk-owner.md) | defined but unselected after the live DAG proved both direct predecessors migrated. No executable/test path changed, no review or computational check ran, and Step `06` remains blocked and uncreated. |
...
unselected [`MIG-03J`](../tasks/TODO/MIG-03J-migrate-split-n-cigar-reads-with-gatk-owner.md)
and sequential [`REVIEW-ARCH-03J`](../tasks/IN_PROGRESS/REVIEW-ARCH-03J-review-split-n-cigar-reads-with-gatk-migration.md)
...
Architecture alone is now selected; no finding, executable/test path change,
or computational check belongs to this selection checkpoint. Step `06` and
