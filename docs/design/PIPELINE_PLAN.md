...
| Sixth JIT-tranche reviews | completed [`REVIEW-ARCH-03F`](../tasks/COMPLETED/REVIEW-ARCH-03F-review-construct-canonical-bam-migration.md) → selected [`REVIEW-REL-03F`](../tasks/IN_PROGRESS/REVIEW-REL-03F-review-construct-canonical-bam-migration.md) → [`REVIEW-UX-03F`](../tasks/TODO/REVIEW-UX-03F-review-construct-canonical-bam-migration.md) | reliability is selected for a read-only independent-in-time pass over helper, transaction, loader, scheduler, coverage, and rollback states; usability and migration remain unselected |
...
completion `c429d8d` are published. `REVIEW-REL-03F` alone is selected in the
commit containing this paragraph; usability, migration, and later owners remain
unselected.
