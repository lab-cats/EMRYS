...
strategy-card base. `TEST-01C` and `TEST-01D` are complete locally; `TEST-01E`
is the next authorized descendant. `CONCURRENCY-02`, `PROGRAM-01`, the
preserved pilot, and Phase `02` remain paused and unselected and are not
