...
| `codex/mig-03l-generate-partitioned-cohort-mpileup-vcfs` | Fresh execution branch for completed [`MIG-03L`](../tasks/COMPLETED/MIG-03L-migrate-generate-partitioned-cohort-mpileup-vcfs-owner.md), unselected [`MIG-03M`](../tasks/TODO/MIG-03M-migrate-preprocess-and-annotate-cohort-candidates-owner.md), completed [`REVIEW-ARCH-03M`](../tasks/COMPLETED/REVIEW-ARCH-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) and [`REVIEW-REL-03M`](../tasks/COMPLETED/REVIEW-REL-03M-review-preprocess-and-annotate-cohort-candidates-migration.md), and active [`REVIEW-UX-03M`](../tasks/IN_PROGRESS/REVIEW-UX-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) | reliability completion `fd00094` is published/equal. Usability alone is selected in the commit containing this row; migration remains unselected, with no Step `09` or later card preloaded. |
...
| Thirteenth JIT-tranche reviews | completed [`REVIEW-ARCH-03M`](../tasks/COMPLETED/REVIEW-ARCH-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) → completed [`REVIEW-REL-03M`](../tasks/COMPLETED/REVIEW-REL-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) → active [`REVIEW-UX-03M`](../tasks/IN_PROGRESS/REVIEW-UX-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) | usability alone is selected from published/equal reliability completion `fd00094`; migration remains unselected, and no Step `09` or later card is preloaded. |
| Phase `03` thirteenth bounded package | Move `preprocess_and_annotate_cohort_candidates` through [`MIG-03M`](../tasks/TODO/MIG-03M-migrate-preprocess-and-annotate-cohort-candidates-owner.md) | defined but unselected from clean/equal MIG-03L documentation close `4562ec3`; architecture fixes four native and four direct-test moves plus ten explicit integration owners, and reliability fixes five pre-cutover test-only checkpoints. No executable/test file changed or ran under review, and no Step `09` or later card is created. |
...
→ [`REVIEW-UX-03M`](../tasks/IN_PROGRESS/REVIEW-UX-03M-review-preprocess-and-annotate-cohort-candidates-migration.md).
...
Usability alone is selected in the checkpoint containing this plan; migration
remains unselected, no executable/test file changed or ran, and no Step `09` or
