...
| Fifteenth JIT-tranche reviews | selected [`REVIEW-ARCH-03O`](../tasks/IN_PROGRESS/REVIEW-ARCH-03O-review-assemble-scientific-review-evidence-package-migration.md) → unselected [`REVIEW-REL-03O`](../tasks/TODO/REVIEW-REL-03O-review-assemble-scientific-review-evidence-package-migration.md) → unselected [`REVIEW-UX-03O`](../tasks/TODO/REVIEW-UX-03O-review-assemble-scientific-review-evidence-package-migration.md), for unselected [`MIG-03O`](../tasks/TODO/MIG-03O-migrate-assemble-scientific-review-evidence-package-owner.md) | architecture alone is selected after published/equal definition `86b8888`; it must prove the exact native/test/example/schema move boundary, import-consumer cutover, artifact/run-summary/report paths, coverage continuity, and rollback before reliability may be selected. |
