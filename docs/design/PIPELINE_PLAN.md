...
| Twelfth JIT-tranche reviews | completed [`REVIEW-ARCH-03L`](../tasks/COMPLETED/REVIEW-ARCH-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md) → completed [`REVIEW-REL-03L`](../tasks/COMPLETED/REVIEW-REL-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md) → active [`REVIEW-UX-03L`](../tasks/IN_PROGRESS/REVIEW-UX-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md) | usability alone is selected from published/equal reliability completion `db33d9c`; migration remains unselected while exact final commands, recovery, scientific language, provenance, and evidence ceilings are reviewed. |
...
Usability alone is selected from published/equal reliability completion
`db33d9c`; no finding is recorded yet. Migration remains unselected, no
