...
| Seventh JIT-tranche reviews | completed [`REVIEW-ARCH-03G`](../tasks/COMPLETED/REVIEW-ARCH-03G-review-collect-canonical-bam-qc-evidence-migration.md) → completed [`REVIEW-REL-03G`](../tasks/COMPLETED/REVIEW-REL-03G-review-collect-canonical-bam-qc-evidence-migration.md) → selected [`REVIEW-UX-03G`](../tasks/IN_PROGRESS/REVIEW-UX-03G-review-collect-canonical-bam-qc-evidence-migration.md) | usability is selected for the final read-only command, diagnostics, findability, recovery, provenance, and evidence-ceiling pass; migration remains unselected |
...
`9b4b5a8` are published and reliability completion `56bac42` is published.
`REVIEW-UX-03G` alone is selected in the commit containing this paragraph;
migration, Step `03`, Step `04`, and all later owner cards remain unselected.
