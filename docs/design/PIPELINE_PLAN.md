...
| Sixth JIT-tranche reviews | completed [`REVIEW-ARCH-03F`](../tasks/COMPLETED/REVIEW-ARCH-03F-review-construct-canonical-bam-migration.md) → completed [`REVIEW-REL-03F`](../tasks/COMPLETED/REVIEW-REL-03F-review-construct-canonical-bam-migration.md) → selected [`REVIEW-UX-03F`](../tasks/IN_PROGRESS/REVIEW-UX-03F-review-construct-canonical-bam-migration.md) | usability alone is selected for the final read-only journey pass; migration remains unselected |
...
Architecture and reliability are complete, and usability alone is selected in
the commit containing this paragraph; migration and later owners remain
unselected.
