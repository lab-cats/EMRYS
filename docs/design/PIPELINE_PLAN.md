...
| Twelfth JIT-tranche reviews | active [`REVIEW-ARCH-03L`](../tasks/IN_PROGRESS/REVIEW-ARCH-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md) → [`REVIEW-REL-03L`](../tasks/TODO/REVIEW-REL-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md) → [`REVIEW-UX-03L`](../tasks/TODO/REVIEW-UX-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md) | architecture alone is selected from published/equal definition `8dc6128`; reliability, usability, and migration remain unselected while exact cutover, transaction/selector/receipt/mutation/scheduler, final-command, recovery, provenance, evidence-ceiling, and rollback boundaries remain review-owned. |
| Phase `03` twelfth bounded package | Unselected move of `generate_partitioned_cohort_mpileup_VCFs` through [`MIG-03L`](../tasks/TODO/MIG-03L-migrate-generate-partitioned-cohort-mpileup-vcfs-owner.md) | definition only from published close `b73b12b`; the candidate is one Step `07` owner with three native assets, two active direct tests, explicit callers, and no executable/test mutation or Step `08` preload. |
...
definition checkpoint containing this plan creates only unselected
[`MIG-03L`](../tasks/TODO/MIG-03L-migrate-generate-partitioned-cohort-mpileup-vcfs-owner.md)
and sequential
[`REVIEW-ARCH-03L`](../tasks/IN_PROGRESS/REVIEW-ARCH-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md)
→ [`REVIEW-REL-03L`](../tasks/TODO/REVIEW-REL-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md)
→ [`REVIEW-UX-03L`](../tasks/TODO/REVIEW-UX-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md).
Architecture review alone is selected from published/equal definition
`8dc6128`; no finding is recorded yet. Reliability, usability, and migration
remain unselected, no executable/test path changed, no computational check
ran, and Step `08` and every later owner/review card remain absent.
