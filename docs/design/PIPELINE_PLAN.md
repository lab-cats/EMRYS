...
boundary, and `REVIEW-UX-03I` completes in the commit containing this paragraph
with final-path, preservation, provenance, and rollback journeys. Migration
remains unselected. No executable/test file changes or test runs, and Step `05`
and every later owner/review card remain uncreated and unselected.
