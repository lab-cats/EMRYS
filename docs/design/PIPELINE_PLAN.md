...
| Second JIT-tranche reviews | [`REVIEW-ARCH-03B`](../tasks/TODO/REVIEW-ARCH-03B-review-construct-star-index-migration.md) → [`REVIEW-REL-03B`](../tasks/TODO/REVIEW-REL-03B-review-construct-star-index-migration.md) → [`REVIEW-UX-03B`](../tasks/TODO/REVIEW-UX-03B-review-construct-star-index-migration.md) | proposed sequential read-only passes for exactly one dependency-valid owner; none is selected by card creation |
