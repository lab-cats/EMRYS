...
MIG-03O remains unselected, architecture review is complete, reliability alone
is selected, and usability remains unselected. No later owner or final-audit
package is created or selected, and the preserved program remainder remains
frozen. The chronology below records how the current physical-migration
...
only unselected MIG-03O, completed architecture, selected reliability, and
unselected usability. Architecture completion `d9ad4da` is published/equal;
reliability selection is the checkpoint containing this plan. Remote `master`
