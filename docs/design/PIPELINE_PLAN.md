...
| Eighth JIT-tranche reviews | completed [`REVIEW-ARCH-03H`](../tasks/COMPLETED/REVIEW-ARCH-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → completed [`REVIEW-REL-03H`](../tasks/COMPLETED/REVIEW-REL-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → selected [`REVIEW-UX-03H`](../tasks/IN_PROGRESS/REVIEW-UX-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) | usability is selected for a read-only independent-in-time journey pass; migration remains unselected pending final commands, diagnostics, evidence-language, provenance, and rollback corrections |
...
checkpoint `1d1de19`; `REVIEW-UX-03H` alone is selected in the commit containing this
paragraph. Migration, Step `04`, and all later owner/review cards remain
unselected.
