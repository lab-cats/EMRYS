...
| Sixth JIT-tranche reviews | completed [`REVIEW-ARCH-03F`](../tasks/COMPLETED/REVIEW-ARCH-03F-review-construct-canonical-bam-migration.md) → completed [`REVIEW-REL-03F`](../tasks/COMPLETED/REVIEW-REL-03F-review-construct-canonical-bam-migration.md) → [`REVIEW-UX-03F`](../tasks/TODO/REVIEW-UX-03F-review-construct-canonical-bam-migration.md) | architecture and reliability are complete with exact helper, rollback-defect, arbitrary-CWD, scheduler-owner, and coverage obligations; usability and migration remain unselected |
| Phase `03` sixth bounded package | Move `construct_canonical_BAM` through [`MIG-03F`](../tasks/TODO/MIG-03F-migrate-construct-canonical-bam-owner.md) | JIT-defined only from published parent `fa79883`; architecture and reliability reviews are complete, no executable/test path moved, and no downstream or later owner is preloaded |
...
Architecture and reliability are complete in the commit containing this
paragraph; usability, migration, and later owners remain unselected.
