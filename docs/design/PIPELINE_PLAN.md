...
| `codex/mig-03n-rank-cohort-candidates-with-paired-cmh` | Fresh migration lane rooted at published repository-health close `57d7ea4`; definition `8bb27d4` created unselected [`MIG-03N`](../tasks/TODO/MIG-03N-migrate-rank-cohort-candidates-with-paired-cmh-owner.md) and its sequential reviews | architecture is complete at `e36cb94`; only [`REVIEW-REL-03N`](../tasks/IN_PROGRESS/REVIEW-REL-03N-review-rank-cohort-candidates-with-paired-cmh-migration.md) is selected for a read-only reliability pass. No executable/test file changed or ran, and usability/migration remain unselected. |
...
| Fourteenth JIT-tranche reviews | completed [`REVIEW-ARCH-03N`](../tasks/COMPLETED/REVIEW-ARCH-03N-review-rank-cohort-candidates-with-paired-cmh-migration.md) → selected [`REVIEW-REL-03N`](../tasks/IN_PROGRESS/REVIEW-REL-03N-review-rank-cohort-candidates-with-paired-cmh-migration.md) → unselected [`REVIEW-UX-03N`](../tasks/TODO/REVIEW-UX-03N-review-rank-cohort-candidates-with-paired-cmh-migration.md) | reliability alone is selected for a read-only pass over transaction/recovery/input stability, guarded-R/oracle parity, validator/private-loader ceilings, scheduler defects, coverage, and rollback; no executable/test file changed or ran and no reliability completion is claimed. |
...
complete and only REVIEW-REL-03N is selected; MIG-03N and usability remain
...
preserved program remainder remains frozen. Complete and publish only the
read-only reliability review before usability selection. The chronology below
records how the current physical-migration boundary was reached.
...
review. Definition `8bb27d4` and architecture completion `e36cb94` are
published/equal; reliability review alone is now selected, no executable/test
