...
supported migration unit at a time: publish this usability completion
checkpoint, then select only `MIG-03D` for task-specific planning and baseline
evidence before executable mutation.
