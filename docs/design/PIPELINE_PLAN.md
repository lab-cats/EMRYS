...
| `codex/mig-03n-rank-cohort-candidates-with-paired-cmh` | Fresh migration lane rooted at published repository-health close `57d7ea4`; definition `8bb27d4` created unselected [`MIG-03N`](../tasks/TODO/MIG-03N-migrate-rank-cohort-candidates-with-paired-cmh-owner.md) and its sequential reviews | only [`REVIEW-ARCH-03N`](../tasks/IN_PROGRESS/REVIEW-ARCH-03N-review-rank-cohort-candidates-with-paired-cmh-migration.md) is selected for a read-only architecture pass; no executable/test file changed or ran, Step `09c` remains blocked, and reliability/usability/migration remain unselected. |
...
| Fourteenth JIT-tranche reviews | selected [`REVIEW-ARCH-03N`](../tasks/IN_PROGRESS/REVIEW-ARCH-03N-review-rank-cohort-candidates-with-paired-cmh-migration.md) → unselected [`REVIEW-REL-03N`](../tasks/TODO/REVIEW-REL-03N-review-rank-cohort-candidates-with-paired-cmh-migration.md) → unselected [`REVIEW-UX-03N`](../tasks/TODO/REVIEW-UX-03N-review-rank-cohort-candidates-with-paired-cmh-migration.md) | architecture alone is selected for a read-only pass over the exact Bash/R/Python/SLURM cutover, guarded-R and independent-oracle ownership, private Step `09c`/report loading, artifact/coverage identity, and rollback; no review finding or completion is claimed. |
...
closes the authorized `UNREFINED` documentation findings. Only
REVIEW-ARCH-03N is selected; MIG-03N, reliability, and usability remain
...
read-only architecture review before reliability selection. The chronology
below records how the current physical-migration boundary was reached.
...
review. Definition `8bb27d4` is published/equal; architecture review alone is
now selected, no executable/test file changed or ran, and no Step `09c`
