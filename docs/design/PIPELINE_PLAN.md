...
cutover and executable acceptance in published checkpoint `cd3b547`; the commit
containing this paragraph is its separate documentation/lifecycle close. Any
later owner remains unselected.
