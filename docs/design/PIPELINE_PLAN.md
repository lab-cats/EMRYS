...
| Seventh JIT-tranche reviews | completed [`REVIEW-ARCH-03G`](../tasks/COMPLETED/REVIEW-ARCH-03G-review-collect-canonical-bam-qc-evidence-migration.md) → selected [`REVIEW-REL-03G`](../tasks/IN_PROGRESS/REVIEW-REL-03G-review-collect-canonical-bam-qc-evidence-migration.md) → [`REVIEW-UX-03G`](../tasks/TODO/REVIEW-UX-03G-review-collect-canonical-bam-qc-evidence-migration.md) | reliability is selected for the read-only mixed-attempt and failure-preservation pass; usability and migration remain unselected |
...
published and architecture completion `06a69c7` is published.
`REVIEW-REL-03G` alone is selected in the commit containing this paragraph;
usability, migration, Step `03`, Step `04`, and all later owner cards remain
unselected.
