...
| Seventh JIT-tranche reviews | completed [`REVIEW-ARCH-03G`](../tasks/COMPLETED/REVIEW-ARCH-03G-review-collect-canonical-bam-qc-evidence-migration.md) → completed [`REVIEW-REL-03G`](../tasks/COMPLETED/REVIEW-REL-03G-review-collect-canonical-bam-qc-evidence-migration.md) → completed [`REVIEW-UX-03G`](../tasks/COMPLETED/REVIEW-UX-03G-review-collect-canonical-bam-qc-evidence-migration.md) | all three independent-in-time passes are complete with exact cutover, mixed-attempt, command, scheduler, recovery, provenance, and local-only evidence boundaries; migration remains unselected |
| Phase `03` seventh bounded package | Move `collect_canonical_BAM_QC_evidence` through selected [`MIG-03G`](../tasks/IN_PROGRESS/MIG-03G-migrate-collect-canonical-bam-qc-evidence-owner.md) | exact three-test old-path baseline, atomic five-move/nine-update cutover, minimal slice checks, one complete executable card gate, and separate documentation close are frozen; no test mutation has begun |
...
selected at published checkpoint `18703e1`. The exact baseline/cutover write
sets, minimal checks, full card-boundary gate, expected documentation ceiling,
rollback order, and separate close are frozen in the commit containing this
paragraph. Step `03`, Step `04`, and all later owner cards remain uncreated and
unselected.
