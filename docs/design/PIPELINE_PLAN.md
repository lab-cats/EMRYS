...
| `codex/mig-03a-extract-validation-report-library` | One-branch physical migration campaign through completed [`MIG-03A`](../tasks/COMPLETED/MIG-03A-extract-validation-report-library.md), [`MIG-03B`](../tasks/COMPLETED/MIG-03B-migrate-construct-star-index-owner.md), [`MIG-03C`](../tasks/COMPLETED/MIG-03C-migrate-convert-gtf-to-bed12-owner.md), completed [`MIG-03D`](../tasks/COMPLETED/MIG-03D-migrate-align-rna-reads-with-star-owner.md), and JIT-defined [`MIG-03E`](../tasks/TODO/MIG-03E-migrate-construct-fasta-sidecars-owner.md) | the first four units and every dedicated review through `03D` are complete; `MIG-03D` documentation close `5259acb` is published, and `construct_FASTA_sidecars` is the one next dependency-valid unit with all four `03E` cards unselected pending sequential review. |
...
| Fifth JIT-tranche reviews | [`REVIEW-ARCH-03E`](../tasks/COMPLETED/REVIEW-ARCH-03E-review-construct-fasta-sidecars-migration.md) → [`REVIEW-REL-03E`](../tasks/TODO/REVIEW-REL-03E-review-construct-fasta-sidecars-migration.md) → [`REVIEW-UX-03E`](../tasks/TODO/REVIEW-UX-03E-review-construct-fasta-sidecars-migration.md) | architecture review complete; exact private reference-provenance loading, the fourteen-file atomic cutover, non-flat validator test loading, scheduler-test ownership, and rollback are corrected; later reviews and migration remain unselected |
...
`5259acb`. `MIG-03E` definition checkpoint `3c6aaf0` and architecture selection
checkpoint `79af085` are published and equal. `REVIEW-ARCH-03E` is complete in
the commit containing this paragraph; reliability, usability, migration, and
any later owner remain unselected.
