...
| Ninth JIT-tranche reviews | completed [`REVIEW-ARCH-03I`](../tasks/COMPLETED/REVIEW-ARCH-03I-review-mark-bam-duplicates-with-picard-migration.md) → selected [`REVIEW-REL-03I`](../tasks/IN_PROGRESS/REVIEW-REL-03I-review-mark-bam-duplicates-with-picard-migration.md) → [`REVIEW-UX-03I`](../tasks/TODO/REVIEW-UX-03I-review-mark-bam-duplicates-with-picard-migration.md) | reliability is selected for a read-only independent-in-time pass over direct-final multi-output, tool/temp/scheduler, stable-input, parity, and rollback states; usability and migration remain unselected |
| Phase `03` ninth bounded package definition | Move `mark_BAM_duplicates_with_Picard` through unselected [`MIG-03I`](../tasks/TODO/MIG-03I-migrate-mark-bam-duplicates-with-picard-owner.md) | candidate five-move/ten-update cutover, direct-final multi-output risk, dual-neutral-loader boundary, artifact/coverage continuity, separate-close, and rollback questions are frozen for sequential review. Step `05` and all later owner/review cards remain uncreated. |
...
`REVIEW-REL-03I` alone is selected in the commit containing this paragraph.
Usability and migration remain unselected. No executable/test file changes or
test runs, and Step `05` and every later owner/review card remain uncreated and
unselected.
