...
| Fifth JIT-tranche reviews | [`REVIEW-ARCH-03E`](../tasks/IN_PROGRESS/REVIEW-ARCH-03E-review-construct-fasta-sidecars-migration.md) → [`REVIEW-REL-03E`](../tasks/TODO/REVIEW-REL-03E-review-construct-fasta-sidecars-migration.md) → [`REVIEW-UX-03E`](../tasks/TODO/REVIEW-UX-03E-review-construct-fasta-sidecars-migration.md) | architecture review selected for one read-only pass; reliability, usability, and migration remain unselected; independent authorship will not be claimed |
...
`5259acb`. `MIG-03E` definition checkpoint `3c6aaf0` is published and equal.
Only `REVIEW-ARCH-03E` is selected in the commit containing this paragraph;
reliability, usability, migration, and any later owner remain unselected.
