...
| Eighth JIT-tranche reviews | selected [`REVIEW-ARCH-03H`](../tasks/IN_PROGRESS/REVIEW-ARCH-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → [`REVIEW-REL-03H`](../tasks/TODO/REVIEW-REL-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → [`REVIEW-UX-03H`](../tasks/TODO/REVIEW-UX-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) | architecture is selected for a read-only independent-in-time pass; later reviews and migration remain unselected pending a committed architecture correction |
...
sequential reviews. `REVIEW-ARCH-03H` alone is selected in the commit containing
this paragraph; Step `04` and all later owner/review cards remain uncreated and
unselected.
