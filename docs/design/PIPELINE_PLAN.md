...
| Ninth JIT-tranche reviews | selected [`REVIEW-ARCH-03I`](../tasks/IN_PROGRESS/REVIEW-ARCH-03I-review-mark-bam-duplicates-with-picard-migration.md) → [`REVIEW-REL-03I`](../tasks/TODO/REVIEW-REL-03I-review-mark-bam-duplicates-with-picard-migration.md) → [`REVIEW-UX-03I`](../tasks/TODO/REVIEW-UX-03I-review-mark-bam-duplicates-with-picard-migration.md) | architecture is selected for a read-only independent-in-time pass; later reviews and migration remain unselected pending a committed architecture correction |
...
`TODO`. `REVIEW-ARCH-03I` alone is selected in the commit containing this
paragraph. No executable/test file changes or test runs, and Step `05` and
every later owner/review card remain uncreated and unselected.
