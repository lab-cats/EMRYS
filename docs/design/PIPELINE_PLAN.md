...
| Fifth JIT-tranche reviews | [`REVIEW-ARCH-03E`](../tasks/TODO/REVIEW-ARCH-03E-review-construct-fasta-sidecars-migration.md) → [`REVIEW-REL-03E`](../tasks/TODO/REVIEW-REL-03E-review-construct-fasta-sidecars-migration.md) → [`REVIEW-UX-03E`](../tasks/TODO/REVIEW-UX-03E-review-construct-fasta-sidecars-migration.md) | JIT-defined and unselected; the sequential passes must settle temporary exact-file reference-provenance loading, partial-publication parity, scheduler continuity, and public findability before migration selection |
...
`5259acb`. `MIG-03E` and its three review cards are JIT-defined in the commit
containing this paragraph; all four remain unselected, and no later owner is
preloaded.
