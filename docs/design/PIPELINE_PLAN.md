...
| `codex/mig-03l-generate-partitioned-cohort-mpileup-vcfs` | Fresh execution branch for completed [`MIG-03L`](../tasks/COMPLETED/MIG-03L-migrate-generate-partitioned-cohort-mpileup-vcfs-owner.md), unselected [`MIG-03M`](../tasks/TODO/MIG-03M-migrate-preprocess-and-annotate-cohort-candidates-owner.md), and active [`REVIEW-ARCH-03M`](../tasks/IN_PROGRESS/REVIEW-ARCH-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) | MIG-03L closes at `4562ec3`; MIG-03M definition `546538c` is published/equal. Architecture review alone is selected in the commit containing this row; reliability, usability, and migration remain unselected, with no Step `09` or later card preloaded. |
...
| Thirteenth JIT-tranche reviews | active [`REVIEW-ARCH-03M`](../tasks/IN_PROGRESS/REVIEW-ARCH-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) → [`REVIEW-REL-03M`](../tasks/TODO/REVIEW-REL-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) → [`REVIEW-UX-03M`](../tasks/TODO/REVIEW-UX-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) | architecture alone is selected from published/equal definition `546538c`; reliability, usability, and migration remain unselected while exact cutover, private loaders, transaction/R/validator/scheduler defects, final commands, recovery, evidence ceiling, and rollback remain review-owned. |
| Phase `03` thirteenth bounded package | Move `preprocess_and_annotate_cohort_candidates` through [`MIG-03M`](../tasks/TODO/MIG-03M-migrate-preprocess-and-annotate-cohort-candidates-owner.md) | defined but unselected from clean/equal MIG-03L documentation close `4562ec3`; the proposed boundary is four native and four direct-test moves plus ten explicit integration owners, subject to architecture review. No executable/test file changed or ran, and no Step `09` or later card is created. |
...
The evidence-backed hypothesis is four native and four direct-test moves plus
ten integration owners. Architecture review alone is selected from published/
equal definition `546538c` to prove the exact guarded-R test ownership and
private neutral-report/flat-Step-`09c` loader boundary before reliability fixes
any required old-path test-only slices. No finding is recorded yet; migration
and later reviews remain unselected; no executable/test file changed or ran;
and no Step `09` or later owner is created or preloaded.
