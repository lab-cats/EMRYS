...
| Phase `03` fifth bounded package | Move `construct_FASTA_sidecars` through [`MIG-03E`](../tasks/TODO/MIG-03E-migrate-construct-fasta-sidecars-owner.md) | JIT-defined and fully reviewed; migration remains unselected, no executable/test path moved, and no later owner is preloaded |
...
selection checkpoint `4750161` is published and equal. All three `03E` reviews
are complete in the commit containing this paragraph; migration and any later
owner remain unselected.
