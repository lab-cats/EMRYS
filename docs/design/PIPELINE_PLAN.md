...
| Eighth JIT-tranche reviews | completed [`REVIEW-ARCH-03H`](../tasks/COMPLETED/REVIEW-ARCH-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → [`REVIEW-REL-03H`](../tasks/TODO/REVIEW-REL-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → [`REVIEW-UX-03H`](../tasks/TODO/REVIEW-UX-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) | architecture accepted one atomic five-move/nine-update cutover with exact moved-file depths, test-local roster loading, both demo targets, and no wrapper; reliability, usability, and migration remain unselected |
| Phase `03` eighth bounded package | Move `collect_RSeQC_paired_orientation_evidence` through [`MIG-03H`](../tasks/TODO/MIG-03H-migrate-collect-rseqc-paired-orientation-evidence-owner.md) | defined and blocked by the three sequential reviews; proposed ceiling is five moves plus nine explicit updates with separate old-path baseline, executable card gate, and documentation/lifecycle close |
...
`REVIEW-ARCH-03H` completes in the commit containing this paragraph.
Reliability, usability, migration, Step `04`, and all later owner/review cards
remain unselected.
