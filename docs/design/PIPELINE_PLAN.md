...
| `codex/mig-03l-generate-partitioned-cohort-mpileup-vcfs` | Fresh execution branch for completed [`MIG-03L`](../tasks/COMPLETED/MIG-03L-migrate-generate-partitioned-cohort-mpileup-vcfs-owner.md), unselected [`MIG-03M`](../tasks/TODO/MIG-03M-migrate-preprocess-and-annotate-cohort-candidates-owner.md), completed [`REVIEW-ARCH-03M`](../tasks/COMPLETED/REVIEW-ARCH-03M-review-preprocess-and-annotate-cohort-candidates-migration.md), and active [`REVIEW-REL-03M`](../tasks/IN_PROGRESS/REVIEW-REL-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) | architecture completion `7740584` is published/equal. Reliability review alone is selected in the commit containing this row; usability and migration remain unselected, with no Step `09` or later card preloaded. |
...
| Thirteenth JIT-tranche reviews | completed [`REVIEW-ARCH-03M`](../tasks/COMPLETED/REVIEW-ARCH-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) → active [`REVIEW-REL-03M`](../tasks/IN_PROGRESS/REVIEW-REL-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) → [`REVIEW-UX-03M`](../tasks/TODO/REVIEW-UX-03M-review-preprocess-and-annotate-cohort-candidates-migration.md) | reliability alone is selected from published/equal architecture completion `7740584`; usability and migration remain unselected while transaction/R/validator/scheduler defects and minimal old-path test-only checkpoints remain review-owned. |
...
→ [`REVIEW-REL-03M`](../tasks/IN_PROGRESS/REVIEW-REL-03M-review-preprocess-and-annotate-cohort-candidates-migration.md)
...
and reverse rollback. Reliability review alone is selected in the checkpoint
containing this plan; no finding is recorded yet. Usability and migration
remain unselected; no executable/test file changed or ran; and no Step `09` or
later owner is created or preloaded.
