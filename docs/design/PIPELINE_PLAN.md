...
| Twelfth JIT-tranche reviews | completed [`REVIEW-ARCH-03L`](../tasks/COMPLETED/REVIEW-ARCH-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md) → active [`REVIEW-REL-03L`](../tasks/IN_PROGRESS/REVIEW-REL-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md) → [`REVIEW-UX-03L`](../tasks/TODO/REVIEW-UX-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md) | reliability alone is selected from published/equal architecture completion `ec7e8d9`; usability and migration remain unselected while exact transaction/selector/receipt/mutation/scheduler and parity obligations are reviewed. |
...
→ [`REVIEW-REL-03L`](../tasks/IN_PROGRESS/REVIEW-REL-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md)
...
recorded. Reliability alone is selected from published/equal architecture
completion `ec7e8d9`; no finding is recorded yet. Usability and migration
