...
| Eighth JIT-tranche reviews | [`REVIEW-ARCH-03H`](../tasks/TODO/REVIEW-ARCH-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → [`REVIEW-REL-03H`](../tasks/TODO/REVIEW-REL-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → [`REVIEW-UX-03H`](../tasks/TODO/REVIEW-UX-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) | defined and unselected; the committed sequential review chain must freeze exact owner/caller, direct-final fault, command, scheduler, recovery, provenance, and mechanical-orientation evidence boundaries before migration selection |
...
sequential reviews. All four remain unselected in `TODO`; Step `04` and all
later owner/review cards remain uncreated.
