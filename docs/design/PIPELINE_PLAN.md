...
| Eighth JIT-tranche reviews | completed [`REVIEW-ARCH-03H`](../tasks/COMPLETED/REVIEW-ARCH-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → selected [`REVIEW-REL-03H`](../tasks/IN_PROGRESS/REVIEW-REL-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) → [`REVIEW-UX-03H`](../tasks/TODO/REVIEW-UX-03H-review-collect-rseqc-paired-orientation-evidence-migration.md) | reliability is selected for a read-only independent-in-time pass over direct-final, validation, scheduler, residue, coverage, and rollback behavior; usability and migration remain unselected |
...
`REVIEW-ARCH-03H` completes at published checkpoint `350223f`.
`REVIEW-REL-03H` alone is selected in the commit containing this paragraph;
usability, migration, Step `04`, and all later owner/review cards remain
unselected.
