...
at published checkpoint `ee25492`; `REVIEW-ARCH-03F` alone is selected in the
commit containing this paragraph, and no downstream or later owner is preloaded.
