...
| Tenth JIT-tranche reviews | completed [`REVIEW-ARCH-03J`](../tasks/COMPLETED/REVIEW-ARCH-03J-review-split-n-cigar-reads-with-gatk-migration.md) → active [`REVIEW-REL-03J`](../tasks/IN_PROGRESS/REVIEW-REL-03J-review-split-n-cigar-reads-with-gatk-migration.md) → [`REVIEW-UX-03J`](../tasks/TODO/REVIEW-UX-03J-review-split-n-cigar-reads-with-gatk-migration.md) | reliability alone is selected against the architecture-corrected loader/cutover boundary. No reliability finding is recorded at this selection checkpoint. |
...
and migration were unselected at that boundary. Reliability alone is now
selected; no finding, executable/test path change, or computational check
belongs to this selection checkpoint. Step `06` and every later card remain
absent.
