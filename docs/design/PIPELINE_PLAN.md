...
| Ninth JIT-tranche reviews | completed [`REVIEW-ARCH-03I`](../tasks/COMPLETED/REVIEW-ARCH-03I-review-mark-bam-duplicates-with-picard-migration.md) → completed [`REVIEW-REL-03I`](../tasks/COMPLETED/REVIEW-REL-03I-review-mark-bam-duplicates-with-picard-migration.md) → selected [`REVIEW-UX-03I`](../tasks/IN_PROGRESS/REVIEW-UX-03I-review-mark-bam-duplicates-with-picard-migration.md) | usability alone is selected for a read-only independent-in-time pass over final commands, diagnostics, partial/mixed/stale preservation, provenance, owner discovery, and rollback; migration remains unselected |
...
boundary; `REVIEW-UX-03I` alone is selected in the commit containing this
paragraph. Migration remains unselected. No executable/test file changes or
