...
```text
Create canonical downstream sorted BAM path and BAI.
```
...
Step 02b execute and Step 03 execute also completed successfully, but their job IDs were not recorded in the handoff notes.
