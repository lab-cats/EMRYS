...
| Artifact index, run summary, and reports | [`reporting`](../../src/norad/reporting/README.md); installed artifact-index route `python -I -m norad build artifact-index --source-checkout ABSOLUTE_CANONICAL_CHECKOUT` |
