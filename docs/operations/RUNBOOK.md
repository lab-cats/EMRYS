...
With `--verbose`, Doctor prints its full invocation elapsed time and exit outcome,
including time spent awaiting operator confirmation, plus precise phase times.
