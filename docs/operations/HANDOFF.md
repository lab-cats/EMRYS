...
- Current package: selected
  [`REVIEW-REL-03H`](../tasks/IN_PROGRESS/REVIEW-REL-03H-review-collect-rseqc-paired-orientation-evidence-migration.md)
  for the Step `03` evidence-owner reliability pass. Usability and migration
  remain unselected.
...
- Remote publication and upstream equality: architecture-completion parent
  `350223f` is verified local/upstream/live-remote-equal. Publish and prove the
  selection checkpoint equal before reliability-review completion.
...
is complete at published checkpoint `350223f`; `REVIEW-REL-03H` alone is now
...
`350223f` and only `REVIEW-REL-03H` is selected. Publish and prove this
selection checkpoint equal before completing reliability; usability,
