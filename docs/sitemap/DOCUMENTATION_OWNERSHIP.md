...
| Active and TODO architecture/future design | [`PLAN-02Z`](../tasks/IN_PROGRESS/PLAN-02Z-integrate-future-task-sequence.md); [`FUT-ANALYSIS-01`](../tasks/TODO/FUT-ANALYSIS-01-preprocessing-profiles-and-analysis-modules.md); [`FUT-CLI-03`](../tasks/TODO/FUT-CLI-03-installable-norad-control-plane.md); [`FUT-DATA-02`](../tasks/TODO/FUT-DATA-02-public-reference-and-sra-acquisition.md); [`FUT-SUCCESS-04`](../tasks/TODO/FUT-SUCCESS-04-optional-analysis-and-archival-semantics.md); [`INTAKE-02E`](../tasks/TODO/INTAKE-02E-define-yaml-tsv-run-lifecycle.md); [`LIB-02F`](../tasks/TODO/LIB-02F-define-shared-library-ownership.md) | Retain target-only scopes and explicit non-implementation boundaries. They link to future architecture and decisions rather than becoming current truth. |
| First migration and dedicated reviews | [`MIG-03A`](../tasks/TODO/MIG-03A-extract-validation-report-library.md); [`REVIEW-ARCH-03A`](../tasks/TODO/REVIEW-ARCH-03A-review-validation-publication-migration.md); [`REVIEW-REL-03A`](../tasks/TODO/REVIEW-REL-03A-review-validation-publication-migration.md); [`REVIEW-UX-03A`](../tasks/TODO/REVIEW-UX-03A-review-validation-publication-migration.md) | The migration card owns one neutral validation-report extraction; the three review cards own only its architecture, reliability, and public-boundary challenge. None authorizes executable mutation while TODO. |
