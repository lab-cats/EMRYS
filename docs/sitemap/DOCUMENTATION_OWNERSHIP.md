...
| [`src/norad/libraries/README.md`](../../src/norad/libraries/README.md) | Maintainer; implemented neutral-library owners, exact-path/private-import boundary, and local defect route | In: architecture/inventory/completed migration. Out: implementation and mirrored direct tests. Retain adjacent; it establishes neither a package nor a generic utility namespace. |
