...
| First migration and dedicated reviews | [`MIG-03A`](../tasks/TODO/MIG-03A-extract-validation-report-library.md); [`REVIEW-ARCH-03A`](../tasks/COMPLETED/REVIEW-ARCH-03A-review-validation-publication-migration.md); [`REVIEW-REL-03A`](../tasks/COMPLETED/REVIEW-REL-03A-review-validation-publication-migration.md); [`REVIEW-UX-03A`](../tasks/IN_PROGRESS/REVIEW-UX-03A-review-validation-publication-migration.md) | The migration card owns one neutral validation-report extraction; the completed architecture/reliability cards and selected usability card own only its three review boundaries. No review card authorizes executable mutation. |
