...
| First migration and dedicated reviews | [`MIG-03A`](../tasks/IN_PROGRESS/MIG-03A-extract-validation-report-library.md); [`REVIEW-ARCH-03A`](../tasks/COMPLETED/REVIEW-ARCH-03A-review-validation-publication-migration.md); [`REVIEW-REL-03A`](../tasks/COMPLETED/REVIEW-REL-03A-review-validation-publication-migration.md); [`REVIEW-UX-03A`](../tasks/COMPLETED/REVIEW-UX-03A-review-validation-publication-migration.md) | The migration card owns one neutral validation-report extraction and is selected for read-only planning only; the three completed review cards own its architecture, reliability, and usability review boundaries. No review card or status move authorizes executable mutation. |
