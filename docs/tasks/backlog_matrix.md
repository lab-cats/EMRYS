...
| <code>PERF-04</code> | P3 | Open | Replace quadratic contig-duplicate detection with linear membership validation. | Valid order and exact duplicate diagnostics are preserved, malformed cases remain fail-closed, and increasing-contig fixtures demonstrate linear rather than quadratic growth. |
