...
exception is approved. `INIT-02` and `CV-U22` passed branch-head hosted CI and
await novice/site verification. CV-26 is Completed under the owner's
2026-09-22 structural criterion; its original full-attribution and
institutional E11 timing gates were superseded.
