...
and Results realization, role-aware APIs/CLI, and remaining public/campaign
migration remain Open. Generalized backend and shared-policy layers are
conditional on concrete extension or net-reduction evidence. Workflow/task now
admit exact successor Run authority, reporting inputs are Attempt-owned, and
the temporary successor execution projection is retired.
...
projection. Public Project/Results, role-aware APIs/CLI, and remaining
public/campaign migration remain Open. Generalized backend and shared-policy
interfaces are conditional on the ratified concrete-consumer gates. A
