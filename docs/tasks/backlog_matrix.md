...
exception is approved. `INIT-02` is pending hosted and novice verification;
`CV-U22` has a bounded source picker pending hosted and site verification.
CV-26's structural Doctor reduction is complete,
