...
- [REVIEW-UX-03A](../IN_PROGRESS/REVIEW-UX-03A-review-validation-publication-migration.md) — Fully: user-facing continuity can be reviewed after safety obligations are fixed.
