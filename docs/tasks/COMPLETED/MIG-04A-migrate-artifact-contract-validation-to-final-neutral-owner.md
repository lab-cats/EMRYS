...
- [RPT-05A](../COMPLETED/RPT-05A-relocate-reporting-to-final-source-home.md) — Partially: reporting also requires concrete removal of its private Step `09c` dependency before relocation.
- [SIZE-07F](../COMPLETED/SIZE-07F-decompose-artifact-contract-validator.md) — Partially: decomposition also requires its live size refresh and independent review blockers.
