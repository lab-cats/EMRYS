...
- [REVIEW-REL-03C](../IN_PROGRESS/REVIEW-REL-03C-review-convert-gtf-to-bed12-migration.md) — Fully: reliability review requires an architecture-corrected owner, caller, and rollback boundary.
