...
- [REVIEW-REL-03B](../IN_PROGRESS/REVIEW-REL-03B-review-construct-star-index-migration.md) — Fully: reliability review needs an architecture-corrected owner, consumer, and rollback boundary.
