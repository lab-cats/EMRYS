...
- [REVIEW-REL-03E](../IN_PROGRESS/REVIEW-REL-03E-review-construct-fasta-sidecars-migration.md) — Fully: reliability review requires an architecture-corrected owner, import, caller, and rollback boundary.
