...
- [RPT-05A](../COMPLETED/RPT-05A-relocate-reporting-to-final-source-home.md) — Partially: the public Step `09c` review-package contract and reporting-local dependency-removal slices must still close before reporting relocation.
