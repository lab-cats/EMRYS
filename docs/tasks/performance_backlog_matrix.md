...
| `PC-PERF-06` | Step 06 | `5` | `4` | `5` | Many BAM passes and temporary subsets to one routing pass | 100k/1m/10m reads; wall/RSS/I/O/peak scratch | Headers, records, flags, order, counts, indexes, downstream Step 07 | `PERF-06` |
