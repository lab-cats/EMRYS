...
| `PC-PERF-04` | Reference | `2` | `1` | `2` | Quadratic contig membership to linear | Retained `N=1k/4k/16k` comparison plus deterministic equality/hash-operation oracle | Exact order, duplicate identity, diagnostics, malformed failures, and consumer behavior | `PERF-04` |
...
| `PC-PERF-08` | Steps 04–05 | `4` | `3` | `4` | Reuse producer sidecar indexes | Retained exact 100k Step 04; future Step 05 plus existing/missing/stale/mismatched sidecars | Exact sidecar admission, fallback, and downstream artifacts | `PERF-08` |
