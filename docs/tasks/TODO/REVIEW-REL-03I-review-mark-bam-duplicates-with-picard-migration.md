...
- [REVIEW-ARCH-03I](REVIEW-ARCH-03I-review-mark-bam-duplicates-with-picard-migration.md) — Required: reliability review needs the architecture-corrected owner, caller, helper, artifact, and cutover boundary.
