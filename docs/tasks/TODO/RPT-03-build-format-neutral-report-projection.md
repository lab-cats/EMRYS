...
- [RPT-05A](../TODO/RPT-05A-relocate-reporting-to-final-source-home.md) — Required: new projection implementation must begin inside the final reporting owner rather than extending the temporary flat tree.
