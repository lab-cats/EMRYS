...
- [ARCH-02C](../TODO/ARCH-02C-define-vertical-source-contract-and-test-topology.md) — Fully: target directories and contract ownership can use stable semantic identities.
