...
- [REVIEW-ARCH-03L](REVIEW-ARCH-03L-review-generate-partitioned-cohort-mpileup-vcfs-migration.md) — Required: reliability review needs the architecture-corrected owner, loader, caller, artifact, test, and cutover boundary.
...
Not selected. Blocked on unselected `REVIEW-ARCH-03L`; no executable/test file
changed or ran.
