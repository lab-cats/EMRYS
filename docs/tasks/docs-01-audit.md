...
| [F18](docs-01-discoveries.md#f18-history-filing-rule-and-existing-compendium) | Evidence placement | History requires dated topic files; its seven-topic compendium is undated, with some observation origins unresolved, yet backlog names it as CV transfer destination. | Decide legacy exception versus dated records after mapping links, anchors, and origins. |
...
| [F44](docs-01-discoveries-continued.md#f44-internal-worker-command-ownership) | Ownership terminology | Coordinator docstrings call internal delegated producers “public”; RSeQC opening ambiguously says independently runnable. | Clarify command ownership; retain exact script paths, help, and grouped validators. |
...
| [F51](docs-01-discoveries-continued.md#f51-viking-walkthrough-history-in-the-active-backlog) | Evidence placement | Backlog walkthrough mixes historical Viking observations with current Doctor/resource/submission rules; CV campaign covers only part. | Crosswalk current owners, unique IDs, limits, and links before any lossless transfer. |
