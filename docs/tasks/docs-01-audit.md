...
| [F28](docs-01-discoveries.md#f28-repeated-owner-boilerplate) | Compression candidate | Six stage owners and eight stage/evidence test guides repeat 58 physical lines; twelve contract evidence-ceiling openings add a 24-line review span. | Allowing nine new shared-context lines yields illustrative 21–35 net README lines; contract openings add no established saving. Owner limits and actual savings remain unverified. |
...
| [F91](docs-01-discoveries-third.md#f91-repeated-stage-and-evidence-contract-openings) | Compression candidate | Twelve stage/evidence contract openings use 48 lines, including 24 lines of repeated stage-map authority wording. | A shorter alias/map preamble might save roughly one line per contract; preserve worker/validator routes and evidence classification. Neither 24 nor 48 is a saving estimate. |
