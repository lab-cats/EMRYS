...
| [F179](docs-01-discoveries-sixth.md#f179-cv-01-integrated-journey-account-under-review) | Conditional within-card compression | CV-01's 37-line selected hosted journey account contains a unique integrated sequence alongside resource and fixture detail covered by test and recovery owners. | A private 32-line sketch suggests five local lines; preserve three Slurm Attempts, direct parity, controlled versus site evidence, pending exact-commit CI, and institutional limits. Net saving is unverified. |
