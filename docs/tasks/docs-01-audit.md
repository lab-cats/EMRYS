...
| Task and evidence records | All eight baseline task/history Markdown files (excluding this audit's seven files); 61 CV index entries reconciled to card endings | Original evidence origins and retained artifacts still need independent verification. |
...
Of 169 records, 65 were dismissed after recheck; linked notes give reasons. The final column states evidence limits, not work orders.
...
| [F168](docs-01-discoveries-sixth.md#f168-scheduler-stream-names-repeated-in-the-logging-contract) | Owner-detail overlap | Logging contract's 12-line scheduler passage repeats exact v4 and legacy stream names owned by the coordinator. | A shorter route might save five to seven lines; keep the scheduler/application-log boundary and following event rules. Precise coordinator link remains unresolved. |
