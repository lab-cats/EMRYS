...
| [F05](docs-01-discoveries.md#f05-generic-study-versus-named-evpum1-route) | Reader route | Root, configuration, and Runbook entry routes point own-data readers to fixed EV/PUM1 Quickstart choices. At pinned revision `0cb5d507`, the choice route is clearer, but the continuation still uses the named Project and Slurm. | The generic route remains unverified as a reader journey. |
...
| [F28](docs-01-discoveries.md#f28-repeated-owner-boilerplate) | Compression candidate | Six stage owners and eight stage/evidence test guides repeat 58 physical lines; twelve contract evidence-ceiling openings add a separate 24-line review span. | A shared test explanation with visible owner-local worker/validator distinctions suggests 15 test lines; production routes suggest 10–11 more. Four contract lines are a low-value upper bound. No replacement or net saving is verified. |
...
preservation for each row; each file stays below 600 lines.
