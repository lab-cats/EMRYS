...
Of 163 records, 64 were dismissed after recheck; their reasons remain in the
...
| [F16](docs-01-discoveries.md#f16-polish-merged-pr-tables) | Compression candidate | Polish campaign repeats merged-PR chronology in two tables, each with some unique PR-to-slice mappings. | Git retains routine chronology, but the unique selection map needs a durable route; preserve evidence limits and the heading link. Net saving is unverified. |
...
| [F19](docs-01-discoveries.md#f19-doctor-experiment-evidence-in-workflow-readme) | Evidence placement | CI workflow README repeats a Doctor experiment summary already detailed in the CV backlog. | Serial-probe and resource/cancellation rationale need a durable owner before trimming the workflow's 14 prose lines; net saving unverified. |
...
| [F90](docs-01-discoveries-third.md#f90-completed-tooling-history-in-polish-campaign) | Compression candidate | Five completed polish sections repeat `CI-01`, `DEV-01`, and `CLI-VERSION-01` status and hosted-CI genealogy already recorded in the main matrix. | Seven physical status/CI lines are under review within a 77-line span; preserve unique fixes, measurements and evidence limits. Net saving is unverified. |
| [F91](docs-01-discoveries-third.md#f91-repeated-stage-and-evidence-contract-openings) | Compression candidate | Twelve stage/evidence contract openings use 48 lines, including about 24 lines of repeated stage-map authority wording. | Keep each local alias and worker/validator route; the full openings are not a saving estimate. No net saving is measured. |
...
| [F107](docs-01-discoveries-fourth.md#f107-retired-shell-publication-tests-in-a-current-test-guide) | Dismissed after recheck | Shared-library test guide retains the retired shell fault and its original revision beside the current runner suite; six owner contracts retain distinct failure modes. | Test and owner locations match their evidence roles; no redundant exact account or safe saving is established. |
...
| [F140](docs-01-discoveries-fifth.md#f140-generic-selection-policy-repeated-in-the-polish-campaign) | Compression candidate | Polish campaign repeats a five-bullet generic selection checklist already governed by workflow and architecture guardrails. | A shorter owner route is plausible; retain the tooling exception, separate-selection warning and dated audit. Net saving is unverified. |
...
| [F142](docs-01-discoveries-fifth.md#f142-collaborator-acceptance-repeated-in-the-polish-campaign) | Acceptance duplication | Polish item 29 repeats external provider/reporter acceptance in two adjacent blocks and the authoritative `EXTENSION-01` row. | Keep the sampled-test limit, no generic DSL or test-only behavior, and bounded interface/service limits; 31 lines are a review span. |
...
| [F158](docs-01-discoveries-fifth.md#f158-campaign-delivery-prose-beside-the-closure-checklist) | Checklist overlap | CV campaign's six-line Delivery opening restates the single remaining-closure checklist in the main matrix. | A one-line route suggests five fewer physical lines, unverified; preserve CV-01, institutional combinations, charter criteria, E01–E12 and evidence limits. |
| [F159](docs-01-discoveries-fifth.md#f159-polish-integration-genealogy-repeated-in-its-introduction) | Compression candidate | Polish campaign's 109–118 selection account repeats PR integration genealogy and hosted-CI evidence held in the main matrix and later dispositions. | Opening lines 68–76 retain tested-tree identity, item 22's CI target, and map navigation; preserve CS-20/22 evidence and owner limits. |
