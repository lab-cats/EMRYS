...
| [F16](docs-01-discoveries.md#f16-polish-merged-pr-tables) | Compression candidate | Polish campaign repeats merged-PR chronology in two tables, each with some unique PR-to-slice mappings. | Git and linked PRs retain routine chronology; preserve current owner behavior, adjacent evidence limits and the heading link. Net saving is unverified. |
