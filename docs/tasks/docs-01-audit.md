...
| [F19](docs-01-discoveries.md#f19-doctor-experiment-evidence-in-workflow-readme) | Evidence placement | CI workflow README repeats a Doctor experiment summary detailed in CV-26; its 14-line span has 13 prose lines and one blank. | Serial policy has an optimization-campaign route, but CV-26's resource/cancellation rationale needs a durable home; net saving unverified. |
