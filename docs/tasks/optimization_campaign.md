...
FASTA and STAR Genome file; do not extrapolate from tiny fixtures.
...
- The standalone FASTQ helper's repeated scans are outside the normal DAG.
  ...
  optimization is deferred until the [byte and diagnostic contract][fastq-admission]
...
[fastq-admission]: ../../src/emrys/ingestion/sample_manifest_admission/README.md
