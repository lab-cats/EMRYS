...
phase, runtime-probe and Slurm accounting records. Selected full E2E evidence
remains part of the broader CV-01/final-source campaign, not CV-26 closure.
Even a passing run would establish only hosted observation, not a Viking
speedup or an explanation of historical E11 latency.
