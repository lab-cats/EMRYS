...
representation are now fixed; public exposure, Project/Results representation,
generalized storage relationships, and remaining migration remain Open. The
