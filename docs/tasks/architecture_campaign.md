...
|---|---|---|
| `AC-DEC-005` | What broader merge semantics remain beyond the implemented execution-profile boundary? | Section 13.26 settles Project-local behavior. Site/global precedence and broader list/map/null semantics remain Open under `OPS-01`. |
...
| `OPS-01` | Section 13.26 records implemented Project-local execution-profile selection. Site/global discovery, management, broader precedence, storage/operator integration, and the final safe override roster remain Open. |
