...
| CV-03 · VP · 2334–2394 | Six scheduler/execution failure phases, one-submission and uncertain-job protections, CI 34991470527; queued and cancelled site outcomes remain. | First-slice and head-finalization sequence at 2344–2370 may condense after the contract and check move. |
...
| CV-26 · Open · 3752–4061 | Original complete-operation attribution/comparable-measurement requirement; 175.681-second hosted setup, exact probe and four-trial artifacts/hashes, decision to retain fresh content checks and defer digest caching, serial-R decision, failed-prototype distinction, negative operator report, five-to-four structural reduction without Viking speedup. | Instrumentation/prototype prose at 3765–3788, 3814–3849 and 3881–3904 is an evidence-transfer project; retain all unique counters and decisions. |
...
| CV-U28 · VP · 1748–1867 | Eight-versus-four-hour operator report, 78/72/6 branch provenance, fixed-policy values/commits, separate 46-branch/11-harness benchmark context and older Slurm-wrapper/VM contexts, native-memory approval and tests, September 21 allocation-aware supersession, no comparable speedup or safe-RSS claim. | Execution/test chronology at 1792–1840 requires an exact dated evidence home before shortening. |
