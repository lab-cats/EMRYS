...
[Step `09c` evidence owner](../../src/norad/evidence/scientific_review_package/README.md)
...
[`test_step_09c_scientific_validation.py`](../../tests/evidence/scientific_review_package/test_step_09c_scientific_validation.py).
