...
| Runtime availability | Operators | Public, single-owner input for [runtime-availability inspection](../src/norad/evidence/runtime_availability/README.md) through `python -I -m norad inspect runtime-availability` | Current structural starter; illustrative probes establish no availability | [`runtime_preflight.example.tsv`](runtime_preflight.example.tsv) |
