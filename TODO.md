...
`2538006`. No residual-convergence package is selected; unblocked
[`RPT-05A`](docs/tasks/TODO/RPT-05A-relocate-reporting-to-final-source-home.md)
is the next preferred JIT move but remains unselected.
