...
SCOPE_ADAPTER_ROSTERS: dict[str, Counter[str]] = {
    ...
    "02": Counter(
        {"step02_canonical_bam_v1": 1, "step02_canonical_bai_v1": 1}
    ),
    "02b": Counter(
        {"step02b_quickcheck_v1": 1, "step02b_flagstat_v1": 1}
    ),
    "03": Counter({"step03_rseqc_infer_v1": 1}),
    "04": Counter(
        {
    ...
    "05": Counter(
        {"step05_split_bam_v1": 1, "step05_split_bai_v1": 1}
    ),
    "06": Counter(
        {
            "step06_fwd_bam_v1": 1,
    ...
    "07": Counter(
        {"step07_mpileup_vcf_v1": 2, "step07_mpileup_receipt_v1": 1}
    ),
    "08": Counter(
        {
            "step08_sites_v1": 1,
