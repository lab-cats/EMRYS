...
| Quarto environment | [`restore_quarto.py`](restore_quarto.py) |
...
| Make implementation | [`make_quality.mk`](make_quality.mk), [`make_reporting.mk`](make_reporting.mk), [`make_cluster_demo.mk`](make_cluster_demo.mk) |

Exact invocations belong in the [runbook](../docs/operations/RUNBOOK.md).
Dependency restoration is explicit operator mutation. Validation and restore
success do not establish runtime, cluster, scientific-review, or biological
evidence.
