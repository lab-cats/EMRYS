...
for NORAD's fixed one-host workflow. It selects Snakemake's local executor,
...
Snakemake. Operators should use `norad run` and `norad resume`, not invoke the
profile directly. See the parent [workflow overview](../../README.md), the
[local-pilot owner](../../../src/norad/orchestration/local_pilot/README.md), and
