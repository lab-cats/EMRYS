...
[`TROUBLESHOOTING`](../../../../docs/operations/TROUBLESHOOTING.md) for missing,
malformed, hash, contig, or publication failures. Current evidence is local
fixture evidence only, not a production reference report or cluster proof.
