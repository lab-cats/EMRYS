...
Jinja template. View-specific banner classes and bounded scientific-figure
cards distinguish the documents without creating separate themes or evidence
policy in CSS. Its selectors change with the owned template rather than
defining a public styling API.
