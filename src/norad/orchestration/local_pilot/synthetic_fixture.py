...
from norad.orchestration.local_pilot.onboarding import (
    OnboardingError,
...
FIXTURE_SCHEMA = "norad.synthetic-local-pilot.v1"
...
def _gtf_bytes() -> bytes:
    ...
    return "".join(
        f"{CONTIG}\tnorad-poc\t{feature}\t{start}\t{end}\t.\t{strand}\t.\t{attributes}\n"
