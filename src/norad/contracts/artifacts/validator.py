"""Validate explicit NORAD artifact contracts through the grouped CLI."""
...
from norad.contracts.artifacts._artifact_contracts.definitions import (
    SCHEMA_FILES,
...
def _validate_document(name: str, document_path: Path) -> dict[str, Any]:
    ...
    from norad.contracts.artifacts import api  # ruff: ignore[import-outside-top-level]
...
def _validate_selected(arguments: argparse.Namespace) -> None:
    ...
    from norad.contracts.artifacts import api  # ruff: ignore[import-outside-top-level]
    from norad.contracts.artifacts._artifact_contracts.schema import (  # ruff: ignore[import-outside-top-level]
