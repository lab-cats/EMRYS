...
- [Run result manifest v7](v3/run_summary.schema.json) owns shared Run identity, input bindings and publication provenance.
- [Report receipt v7](v5/report_receipt.schema.json) binds both HTML projections, their data inputs and their original renderer identities.
