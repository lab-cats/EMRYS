...
def _result(
    ...
    *,
    ...
    source = (
        ...
        else f"results/{directory}/{{analysis_id}}/{{analysis_id}}.{filename}.{extension}"
    )
...
_STEP09_RESULTS = (
    ...
    ("cmh_significant_sites", "sample_blocks_tsv", step09.STEP09_RESULT_HEADER, None),
...
_STEP10_OUTPUTS = tuple(
    ...
    _result(
        ...
        "validation_report",
        module_api.VALIDATION_REPORT_HEADER,
        len(scientific_context.VALIDATION_CHECK_IDS),
