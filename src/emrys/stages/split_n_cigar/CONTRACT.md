...
`samtools index` remains the fallback. It does not publish a receipt, prove
BAM/BAI correspondence, or prove that CIGAR-N transformation semantics
occurred.
...
- [`test_step_05_split_n_cigar_reads.sh`](../../../../tests/stages/split_n_cigar/test_step_05_split_n_cigar_reads.sh)
  ...
  current-attempt native-index reuse and fallback, staged validation,
  complete-pair rules, and ordinary rollback fault paths.
