...
RSeQC-orientation, duplicate-marking, split-N-cigar, and mechanical-orientation
validation, plus GTF-to-BED12 conversion/validation and named schema/report
resources.
