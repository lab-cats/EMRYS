...
CONSUMERS = {
    ...
    "stages/star_alignment/step_01_star_align.sh": (0o755, 2, 0, 1),
    ...
    "analyses/paired_cmh_candidate_ranking/scientific_context_projection/scientific_context_projection.sh": (
        0o755,
        1,
        0,
        1,
