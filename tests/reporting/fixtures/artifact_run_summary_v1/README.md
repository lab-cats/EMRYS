...
`build_fixture.py` composes temporary artifact-index and Step 09c inputs for
run-summary, export, and rendering tests. It owns synthetic incomplete and
explicitly reviewed fixture states; generated outputs stay under the caller's
temporary root.
